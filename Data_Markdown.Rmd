...
MF - LET'S NOT RUN THIS UNTIL WE HAVE THE DATA WE NEED
```{r eval = FALSE}
## load fire department data
FD = read.csv("~/Github/Nashville_IMV/data/metro/Bars-&-Nightclubs-with-Occupant-Loads_2023-03-24_131105.csv")
...
MF - I STOPPED HERE 8/24 - NEXT STEP IS TO ADD ZONING DATA AND TABULAR JOIN, AND THEN DO SOME WORK ON THE AGGREGATES. I WILL CREATE THE IMV INDICATORS HERE AND THEN ALSO TABULATE THEM IN THE AGGREGATES
