...
#not sure why NAs are introduced  
  ...
  summarize(num_venues = n(),
            ...
            Quasi_IMV_n = sum(IMV_ord,na.rm=TRUE),
...
st_write(d1_aggregates, "~/GitHub/Nashville_IMV/data/venue_tables/to_map/d1_aggregate_v3.geojson")

st_write(venue_full, "~/GitHub/Nashville_IMV/data/venue_tables/to_map/venues_v3.geojson")
