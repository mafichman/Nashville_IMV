...
variables_business = c("name","BUSNAME","address_admin","PropAddr","APN","ACCOUNT","BUSTYPE","OWNER","APPRVALUE","ASSDVALUE")
...
st_write(d1_aggregates, "~/GitHub/Nashville_IMV/data/venue_tables/to_map/d1_aggregate_v5.geojson")

st_write(venue_full, "~/GitHub/Nashville_IMV/data/venue_tables/to_map/venues_v4.geojson")

```

#business license stuff
```{r}
manual_business_match = read.csv("C:/Users/sofia/Documents/UPenn/Nashville/manual_business_license.csv")
