...
nash_venue_data <- st_read("~/GitHub/Nashville_IMV/data/venue_tables/to_map/venues_v5.geojson") %>%
...
- Only 18.5% of music spaces and occasional music spaces have are identified in administrative records as having events, music, theater or nightclub use.
