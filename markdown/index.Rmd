...
- Zoning - what are the types we are seeing
...
## 5.6. Venues, Programming and Centrality
...
### 9.1.1 Cluster programming characteristics
...
nash_venue_data %>% 
  ...
  geom_bar(aes(x = variable, y = value, fill = as.factor(cluster)), 
   ...
   labs(
    title = "Venue Typologies, Sydney, 2023",
...
risk_matrix <- nash_venue_data %>%
  ...
  mutate(cumulative_risk = sum(appraisal_ratio + Condition_ord +
