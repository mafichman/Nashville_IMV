...
- Add property condition, year built, building use and other data in the data_markdown (Michael)
...
# Read in district aggregates
d1_aggregates_nash <- st_read("~/GitHub/Nashville_IMV/data/venue_tables/to_map/d1_aggregate_v4.geojson") %>%
  st_as_sf(crs = 4326) %>%
...
nash_venue_data <- st_read("~/GitHub/Nashville_IMV/data/venue_tables/to_map/venues_v3.geojson") %>%
...
## 5.5. Venue Structures and Property Characteristics
